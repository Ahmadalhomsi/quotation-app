...
export default function LoginPage() {
  ...
  useEffect(() => {
    const checkAutofill = () => {
      ...
      if (usernameInput && passwordInput) {
        ...
        // Update state if autofilled values differ from current state
    ...
    // Check for autofill after component mounts and periodically
  ...
  // Use onInput instead of onChange to handle browser autofill
